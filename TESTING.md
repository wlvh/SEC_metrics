...
| Issue #15 zero-AI R2 active | 同上 | 否 | 否；只读R2及其R1/A predecessor chain | 22指标、220坐标、141 strict-compatible替换、79 structural新增、309-row exact union、event-key parity、retirement/read-back与三种零调用计数通过 | WB-4以后、AI Reader、39指标最终Cutover、full acceptance |
