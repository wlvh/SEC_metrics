...
PROFILE_REQUIREMENT_GENERATION = "PROFILE_DRIVEN_V6"
PROFILE_SEMANTIC_VERSION = "6"
REQUIREMENT_ID = "issue_28_v5"
PARENT_ID = "issue_28_v4"
DECISION_ID = "S-ANNUAL-RUNTIME"
POLICY_PATH = "docs/evidence/issue_28_annual_runtime_policy.json"
POLICY_SHA256 = "9a79ca9d653973134e92ea08688d4706ed85f467ba3f6c609ac2e44967bdfaaf"
DEPENDENCIES = (Path(v1.__file__), Path(v3.__file__), Path(v4.__file__), Path(v5.__file__), Path(canonical.__file__))
...
def candidate_choice(*, choice):
    ...
    _require(choice["kind"] == "ANNUAL_CANDIDATE_RUNTIME_POLICY"
...
def _load(*, snapshot_dir, parent_loader):
    ...
    _require(register["decisions"][-1] == {"decision_id": DECISION_ID, "status": "APPROVED",
        ...
        "evidence": source["source_url"], "policy_provenance": {"source_id": source["source_id"],
            "section": "annual_runtime_stage", "scope": "POLICY_CONTENT_ONLY"}},
    ...
    evaluated = v1.evaluate_invariant_profile(profile=profile, requirement_id=REQUIREMENT_ID,
        ...
        evaluators={**v3.EVALUATORS, "R4_SOURCE_LABEL_REPRESENTATION": v4._label_choice,
                    ...
                    "ANNUAL_CANDIDATE_RUNTIME_POLICY": candidate_choice})
