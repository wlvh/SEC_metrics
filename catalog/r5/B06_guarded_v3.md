---
{
  ...
  "quality_rule": {
    ...
    "early_terminal_guard": {
      "role": "equity",
      "condition": "nonpositive",
      "required_sources": [
        "primary_inline",
        "accession_xml",
        "same_filing_companyfacts"
      ],
  ...
  "legacy_projection": {
    ...
    "notes": "Nonpositive parent-shareholder equity makes debt-to-equity not meaningful. Equity is source verified; debt completeness is NOT_EVALUATED in this terminal branch."
  },
  "dependencies": []
}
---

# B06 nonpositive denominator successor

This additive resolver may terminate only after all required original sources prove the same-scope period-end shareholder equity is nonpositive. It emits NOT_MEANINGFUL with a null ratio and explicitly leaves debt completeness NOT_EVALUATED. Positive equity continues the existing debt path. Source and scope conflicts cannot be bypassed. This Spec does not change historical Calculator execution or grant Run, activation or publication authority.
