...
This explicit successor also includes original and amended 8-K12B registration filings alongside original and amended 8-K filings and retains ordered annual amendments for both comparison periods. It does not relabel old 8-K-only evidence or change the v1 resolver.

The expanded form set is explicit for this successor. A complete same-CIK annual comparison is still required to conclude no auditor change when no Item 4.01 is found; missing comparison facts remain withheld.
