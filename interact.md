...
首条D04业务申领172实际返回新HTTP402后，公开状态应显示这次失败已计账且PROVIDER再次停止，不能显示为“充值后已恢复”或“D04新公司完成”。用户称充值仅是服务状态说明；针对172的一次性恢复在明确批准及真实服务器记录绑定前保持关闭。若未来获准并成功，原172失败仍在历史和审阅链中，新成功另有编号；若再次402，继续停止。
