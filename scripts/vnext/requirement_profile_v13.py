...
PROFILE_REQUIREMENT_GENERATION = "PROFILE_DRIVEN_V13"
REQUIREMENT_ID = "issue_28_v12"
PARENT_ID = "issue_28_v11"
...
def load_profile_requirement_snapshot(*, snapshot_dir, parent_loader):
    ...
    need(validator["path"] == "scripts/vnext/requirement_profile_v13.py"
    ...
    need(policy["policy_id"] == "issue28_normal_results_v1"
    ...
    return {"artifact_requirement_generation": "EXPLICIT_REQUIREMENT_V1", "baseline": baseline,
        ...
        "issue_contract_revision": "normal-saved-results-v1", "policy": policy}
