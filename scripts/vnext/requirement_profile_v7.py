"""Thin annual runtime extension of the retained Requirement machinery.
...
PROFILE_REQUIREMENT_GENERATION = "PROFILE_DRIVEN_V7"
PROFILE_SEMANTIC_VERSION = "7"
REQUIREMENT_ID = "issue_28_v6"
PARENT_ID = "issue_28_v5"
DECISION_ID = "S-ANNUAL-REPAIR"
POLICY_PATH = "docs/evidence/issue_28_annual_repair_policy.json"
POLICY_SHA256 = "0134fd967508250a34875f8eea90634a12d006fdb7c5c63e001f2fc6a8331e22"
DEPENDENCIES = (Path(v1.__file__), Path(v3.__file__), Path(v4.__file__), Path(v5.__file__), Path(v6.__file__), Path(canonical.__file__))
...
def candidate_choice(*, choice):
    ...
    _require(choice["kind"] == "ANNUAL_CANDIDATE_REPAIR_POLICY"
        and choice["maximum_additional_executions"] == 2
        and choice["maximum_total_executions"] == 3
        and choice["merge_authorized"] is False
        and choice["maximum_new_executions_per_stage"] == 1
...
def _load(*, snapshot_dir, parent_loader):
    ...
    _require(register["decisions"][-1] == {"decision_id": DECISION_ID, "status": "APPROVED",
        ...
        "evidence": source["source_url"], "policy_provenance": {"source_id": source["source_id"],
            "section": "annual_candidate_repair", "scope": "POLICY_CONTENT_ONLY"}},
    ...
    evaluated = v1.evaluate_invariant_profile(profile=profile, requirement_id=REQUIREMENT_ID,
        ...
        evaluators={**v3.EVALUATORS, "R4_SOURCE_LABEL_REPRESENTATION": v4._label_choice,
                    ...
                    "ANNUAL_CANDIDATE_REPAIR_POLICY": candidate_choice})
