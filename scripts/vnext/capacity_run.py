...
def prepare_case(*, data_root, company_id, assessment_mode=None, assessment_input_id=None):
    ...
    return {'kind': 'TEXT', 'primary_metric_id': 'B13', 'input_binding': binding,
        ...
        'selection': {'status': 'TEXT_QUAL', 'reason_code': 'COMPLETE_NATIVE_CAPACITY_ASSESSMENT',
...
def install_inputs(*, data_root, company_id, source_root=ROOT, assessment_mode=None, assessment_input_id=None):
    ...
    _install_case_inputs(data_root=data_root, source_root=source_root, company_id=company_id, case=case,
        requirement=requirement, extra_input_bytes={EXPORT_PATH: canonical_json_bytes(value=case['registered_input'])})
