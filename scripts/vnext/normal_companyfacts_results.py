...
def resolve_ordinary_companyfacts_metrics(*, repo_root: Path, company_id: str):
    ...
    prior_error = None
    common_error = ("NORMAL_COMPANYFACTS_SUCCESSOR_SCOPE_NOT_IMPLEMENTED" if prepared["subject_policy"]["mode"] != "CONTINUOUS_PRIMARY"
    ...
    body = {"record_type":"NORMAL_COMPANYFACTS_NATIVE_RESULTS","company_id":company_id,
        ...
        "authority_file_hashes":authority,"source_records":list(reader.records.values()),"source_proofs":proofs,
