...
_DEI_NAMES = {"documentfiscalyearfocus", "documentperiodenddate", "documentfiscalperiodfocus", "entitycentralindexkey", "documenttype"}
...
def _definitions(raw, target_end):
...
def inspect_fiscal_year_labels(*, primary_bytes: bytes, companyfacts_bytes: bytes,
    ...
    definitions,unparsed=_definitions(primary_bytes,period["period_end"])
    ...
    body={"record_type":"FISCAL_YEAR_LABEL_SOURCE_INSPECTION","schema_version":1,
        ...
        "dei_fiscal_year":period["fiscal_year"],"dei_facts":dei,"companyfacts_fiscal_year_values":cf_labels,
