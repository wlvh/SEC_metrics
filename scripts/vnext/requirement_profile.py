...
from . import requirement_profile_v11 as v11
...
PROFILE_ENGINES = {
    ...
    v5.PROFILE_REQUIREMENT_GENERATION: v5,
    v6.PROFILE_REQUIREMENT_GENERATION: v6,
    ...
    v11.PROFILE_REQUIREMENT_GENERATION: v11,
}
