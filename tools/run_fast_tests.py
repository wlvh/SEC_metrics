...
FAST_TESTS = (
    ...
    "tests.vnext.test_normal_annual_input.NormalAnnualInputTest.test_first_five_company_inputs_with_same_source_checks",
    "tests.vnext.test_normal_annual_input.NormalAnnualInputTest.test_remaining_company_inputs_preserve_transition_and_continue",
