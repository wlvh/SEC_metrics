...
authority_root = verify_data_root(OUT/'offline-acceptance-04/current-start/data', requirement)
...
receipt = {'record_type':'INDEPENDENT_CONTINUITY_CONTENT_REGRESSION','reviewer_kind':'INDEPENDENT_MODEL_SUBTASK',
    ...
    'attempt_1':{'script':file_proof(OUT/'independent-content-regression-attempt-1.py'),'log':file_proof(OUT/'independent-content-regression.log'),'status':'FAILED_REVIEWER_ASSERTION_EXPOSED_OLD_CASE_NAME_LIMIT'},
