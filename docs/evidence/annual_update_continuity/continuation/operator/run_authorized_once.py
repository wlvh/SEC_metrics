...
WORK=Path('/Users/lyuhongwang/Documents/Codex/2026-09-10/annual-update-continuity/continuation')
if len(sys.argv)!=4:
...
env={**{k:v for k,v in os.environ.items() if not k.endswith('_API_KEY')},'DEEPSEEK_API_KEY':key,'PYTHONDONTWRITEBYTECODE':'1','GIT_OPTIONAL_LOCKS':'0',
