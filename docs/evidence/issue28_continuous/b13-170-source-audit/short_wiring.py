...
out=Path('/tmp/issue28_visible_role_wiring_cd18');out.mkdir(exist_ok=False);e=Path(__file__).resolve().parent;started=time.monotonic();r=load_requirement_snapshot(snapshot_dir=ROOT/'requirements/issue_28_v14')
...
(e/'short-wiring-summary.json').write_text(json.dumps(summary,indent=2)+'\n');print(json.dumps(summary),flush=True)
