...
for rel in ['scripts/vnext/ordinary_source_authority.py','scripts/vnext/ordinary_projection.py','scripts/vnext/normal_numeric_projection.py','scripts/vnext/continuous_sec_acquisition.py','scripts/vnext/continuous_call_ledger.py','scripts/vnext/continuous_call_policy.py']:
...
s=s.replace("'offline_wiring_receipt_path':'docs/evidence/issue28_continuous/ordinary-continuity-policy/offline-wiring.json'", "'offline_wiring_receipt_path':'docs/evidence/issue28_continuous/ordinary-sec-acquisition/provider-wiring.json','sec_wiring_receipt_path':'docs/evidence/issue28_continuous/ordinary-sec-acquisition/sec-wiring.json'")
