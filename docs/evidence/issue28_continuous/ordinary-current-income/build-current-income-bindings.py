...
for rel in ['config/ordinary_income_input_v1.json','scripts/vnext/ordinary_income_input.py']:
...
write(p,b)
s=(T/'build_v15_registered_event_runs.py').read_text().replace('ordinary-registered-event-runs/provider-wiring.json','ordinary-current-income/provider-wiring.json').replace('ordinary-registered-event-runs/sec-wiring.json','ordinary-current-income/sec-wiring.json')
(T/'build_v15_current_income.py').write_text(s)
