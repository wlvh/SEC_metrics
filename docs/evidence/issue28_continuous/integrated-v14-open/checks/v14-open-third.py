...
out=Path('/tmp/sec_metrics_issue28_continuous/v14-open-review-order-third');out.mkdir(exist_ok=False)
rows=[]
if True:
 for company,metric in [('marriott_international','B03'),('salesforce','B12'),('marriott_international','D01')]:
