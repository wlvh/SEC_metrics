...
policy={'schema_version':1,'policy_id':'issue28_continuous_calls_v1','repository':'wlvh/SEC_metrics','requirement_id':R,
 ...
 'b13':approval['b13'],'offline_wiring_receipt_path':'docs/evidence/issue28_continuous/ordinary-special-debt-scope/provider-wiring.json','sec_wiring_receipt_path':'docs/evidence/issue28_continuous/ordinary-special-debt-scope/sec-wiring.json','real_execution_state':'REQUIRES_OFFLINE_WIRING_RECEIPT_AND_BOUND_COUNT_CONTROL',
