...
write(p,b)
s=(T/'build_v15_sec.py').read_text().replace('ordinary-document-identity/provider-wiring.json','ordinary-special-debt-scope/provider-wiring.json').replace('ordinary-document-identity/sec-wiring.json','ordinary-special-debt-scope/sec-wiring.json')
(T/'build_v15_special_debt.py').write_text(s)
