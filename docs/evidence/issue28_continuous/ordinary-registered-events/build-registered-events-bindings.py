...
write(p,b)
s=(T/'build_v15_history_identity.py').read_text().replace('ordinary-history-identities/provider-wiring.json','ordinary-registered-events/provider-wiring.json').replace('ordinary-history-identities/sec-wiring.json','ordinary-registered-events/sec-wiring.json')
(T/'build_v15_registered_events.py').write_text(s)
