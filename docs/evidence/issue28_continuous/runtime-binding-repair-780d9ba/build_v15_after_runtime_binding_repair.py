...
policy={'schema_version':1,'policy_id':'issue28_continuous_calls_v1','repository':'wlvh/SEC_metrics','requirement_id':R,
 ...
 'b13':approval['b13'],'offline_wiring_receipt_path':'docs/evidence/issue28_continuous/runtime-binding-repair-780d9ba/offline-wiring.json','real_execution_state':'REQUIRES_OFFLINE_WIRING_RECEIPT_AND_BOUND_COUNT_CONTROL',
 'rule_paths':[P,'scripts/vnext/continuous_call_policy.py','scripts/vnext/continuous_call_ledger.py','scripts/vnext/continuous_semantic_calls.py','scripts/vnext/continuous_call_wiring.py','tools/vnext_continuous_semantic.py','scripts/vnext/capacity_utilization_source.py','config/b13_production_capacity_v1.json','catalog/r5/B13_production_capacity_v1.md','catalog/r5/B13_capacity_disclosures_v1.md','scripts/vnext/requirement_profile_v15.py',comment_path,
