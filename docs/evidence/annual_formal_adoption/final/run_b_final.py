...
try:
    if mode=='prepare':
        ...
        command=['tests.vnext.test_annual_formal_rehearsal.AnnualFormalRehearsalTest.test_complete_version_permission_switch_and_finite_directions', 'tests.vnext.test_annual_formal_rehearsal.AnnualFormalRehearsalTest.test_rehashed_package_policy_mixing_is_rejected'] if mode=='integration' else [
        ...
        assert result.wasSuccessful() and result.testsRun==(2 if mode=='integration' else 1) and not result.skipped
