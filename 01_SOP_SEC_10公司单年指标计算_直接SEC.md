...
用于：CEO/CFO changes、auditor changes、M&A、bankruptcy、leadership departures、restatements、material agreements。
...
Golden assertions 是防止“代码跑通但数字错”的核心机制。断言脚本必须独立于计算脚本，只读取输出矩阵和锁定常量。
